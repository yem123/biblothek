/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 1a50710b55d3f6d6fc6413eec81c5246)
// Runtime types generated with workerd@1.20260714.1 2026-07-18 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	MY_BUCKET: R2Bucket;
	ASSETS: Fetcher;
	PDF_WORKER_URL: string;
	LIBRARY_API: Fetcher /* german-library-api */;
}
